...
var Player = /** @class */ (function (_super) {
    ...
    Player.prototype.start = function () {
        ...
        this.setPosition({
            x: this.getGame().CANVAS_WIDTH / 2 - this.getImage().width / 2, // Place le joueur horizontalement au centre du canvas
            y: this.getGame().CANVAS_HEIGHT - this.getImage().height - 100, // Place le joueur proche du bas du canvas, en tenant compte de la hauteur de son image et un décalage de 10 pixels
        });
    };
